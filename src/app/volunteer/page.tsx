      ...
      <div className="container px-4 mx-auto max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            "Hands that serve are holier than lips that pray." Join us in making the Sai Paduka event seamless and blissful for everyone.
          </p>
        </div>
        ...
        {!isAuthenticated ? (
          <Card className="max-w-md mx-auto shadow-2xl border-primary/20 bg-muted/30">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                To maintain event security and manage volunteer records, please log in with your Google account first.
              </CardDescription>
            </CardHeader>
              ...
              <div className="bg-primary/5 p-6 rounded-2xl border border-primary/10">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-bold">Crowd Management</span>
                      <p className="text-xs text-muted-foreground">Assist devotees in orderly Darshan movement.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-accent shrink-0 mt-0.5" />
                    <div>
                      <span className="font-bold">Prasad Distribution</span>
                      <p className="text-xs text-muted-foreground">Serve bhandara and prasad with devotion.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-accent shrink-0 mt-0.5" />
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Keep the holy premises clean and tidy.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-accent shrink-0 mt-0.5" />
                    <div>
                      <span className="font-bold">Medical Help</span>
                      <p className="text-xs text-muted-foreground">Assist in basic first-aid and medical support.</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <Card className="md:col-span-2 shadow-xl border-primary/20">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <CardFooter>
                  <Button 
                    type="submit" 
                    className="w-full bg-primary hover:bg-primary/90 h-12 text-lg shadow-lg"
                    disabled={isSubmitting}
                  >
